...
GM.UseSteamNames = CreateConVar("mu_use_steam_names", 0, bit.bor(FCVAR_NOTIFY), "Use players' Steam names instead of generated bystander names (0 = generated, 1 = Steam names)" )
